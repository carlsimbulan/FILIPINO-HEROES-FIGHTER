...
- A background color: ALWAYS #000000 (pure black) — every section uses the same black background, no alternating, no variations
...
- The landing page background is ALWAYS #000000 (pure black). No other background colors for page sections — only #000000.
- All sections share the same solid black background. Do not alternate between light/dark section fills.
- Visual depth comes from dotted borders (brand blue), subtle blue glow shadows, and neon-colored text accents — not from background color variation.
- Decorative elements should reinforce the arcade/retro game aesthetic: pixel art motifs, dot patterns, maze-like grid lines, Pac-Man ghost/pellet iconography.
...
- Background: #000000 on every section — no exceptions
