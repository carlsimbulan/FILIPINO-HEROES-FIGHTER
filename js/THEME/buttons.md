...
- **Glint effect:** Every button except ghost and disabled gets a combined box-shadow that layers the base shadow with an inset top-edge highlight and a subtle outer color glow:
  - `var(--shadow-xs), inset var(--color-1-400) 0 1px 0px 0px, var(--color-1-700) 0 1px 2px -1px`
- **Font weight:** 400 (regular — Press Start 2P only weight)
- **Font:** 'Press Start 2P'
...
|---|---|---|---|
| Extra small | 8px | 12px | 6px |
| Small | 10px | 12px | 8px |
| Base (default) | 12px | 16px | 10px |
| Large | 14px | 20px | 12px |
| Extra large | 14px | 24px | 14px |
